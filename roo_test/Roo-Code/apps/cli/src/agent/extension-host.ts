...
export class ExtensionHost extends EventEmitter implements ExtensionHostInterface {
	...
	constructor(options: ExtensionHostOptions) {
		...
		const baseSettings: RooCodeSettings = {
			...
			...getProviderSettings(this.options.provider, this.options.apiKey, this.options.model, this.options.baseUrl, this.options.contextWindow, this.options.temperature, this.options.topP, this.options.topK),
		}
